...
export const DeviceTvOldFilledIcon = ({
	...
	<svg {...svgProps} fill={color} viewBox="0 0 24 24" width="100%" height="100%">
		...
		<path d="M18 14a1 1 0 0 1 .993.883l.007.127a1 1 0 0 1-1.993.117L17 15a1 1 0 0 1 1-1m0-3a1 1 0 0 1 .993.883l.007.127a1 1 0 0 1-1.993.117L17 12a1 1 0 0 1 1-1" />
	</svg>
)
