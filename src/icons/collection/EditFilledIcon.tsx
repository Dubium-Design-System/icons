...
export const EditFilledIcon = ({
	...
	<svg {...svgProps} fill={color} viewBox="0 0 24 24" width="100%" height="100%">
		...
		<path d="m14.596 5.011 4.392 4.392-6.28 6.303A1 1 0 0 1 12 16H9a1 1 0 0 1-1-1v-3a1 1 0 0 1 .294-.708zm6.496-2.103a3.097 3.097 0 0 1 .165 4.203l-.164.18-.693.694-4.387-4.387.695-.69a3.1 3.1 0 0 1 4.384 0" />
	</svg>
)
